...
const scriptsFileName = cp
  .execSync(`npm pack`, { cwd: path.join(packagesDir, 'jamstack-scripts') })
  .toString()
  .trim();
const scriptsPath = path.join(packagesDir, 'jamstack-scripts', scriptsFileName);
...
const craScriptPath = path.join(packagesDir, 'create-jamstack-app', 'index.js');
