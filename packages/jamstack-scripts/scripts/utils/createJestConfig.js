  ...
  if (overrides) {
    ...
    if (unsupportedKeys.length) {
      ...
      if (isOverridingSetupFile) {
        ...
        console.error(
          chalk.red(
            '\nOut of the box, Create Jamstack App only supports overriding ' +
              'these Jest options:\n\n' +
              supportedKeys
              ...
              'are not currently supported by Create Jamstack App:\n\n' +
              unsupportedKeys
                .map(key => chalk.bold('  \u2022 ' + key))
                .join('\n') +
              ...
              'You may also file an issue with Create Jamstack App to discuss ' +
